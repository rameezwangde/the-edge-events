...
export default function ExperienceStatement() {
  const customCards = [
    ...
    },
    {
      ...
      titleClassName: "text-white",
      className:
        "[grid-area:stack] translate-x-8 translate-y-64 hover:translate-y-60",
    },
  ];
  ...
  return (
    <section className="people section-space">
      ...
      <div className="page-shell people-content">
        ...
        <div className="flex w-full items-center justify-center py-20 lg:py-0 lg:justify-start lg:-ml-32">
